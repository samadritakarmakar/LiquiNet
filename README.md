...
The Program by default is independent of the type of Unit system used. But the default values shown at the start of the program are in SI units. Hence, if the user wants to use units of his choice, suppose the FPS system, then he must take care of that the input values are in correct FPS values.  
